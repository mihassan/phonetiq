...
Phonetiq/
  api/                        # Cloudflare Worker (Hono)
    ...
    scripts/
      run-eval.ts             # Dialect-tagged eval harness (+ schema-versioned full/summary JSON, strict guardrails, family rollups)
      run-eval-experiment.ts  # Frame eval variant (+ schema-versioned full/summary JSON, strict guardrails, family rollups)
