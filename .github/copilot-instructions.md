...
npm run dev:frame           # Frame-sentence profile on 8791
...
- `api/src/routes/recognize.ts` handles candidate-constrained Whisper matching with frame-sentence extraction.
